export const getPagination = (page, size ) => { // Se reciben por ejemplo la cantidad de paginas y el tamaño de cada pagina 
    const limit = size ? +size : 10; // en operador ternario se pregunta que si hay un tamaño definido, si, si se convierte en un numero, si no, se da un tamaño por defecto de por ejemplo //3//
